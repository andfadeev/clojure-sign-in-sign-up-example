(ns clojure-sign-up-sign-in-example.views)

;; I've used HyperUI components https://www.hyperui.dev/
;; Just copy/pasted and let Cursive convert it to Hiccup
  ...
  [:div.container.mx-auto
   [:div.flow-root.rounded-lg.border.border-gray-100.py-3.shadow-sm
    [:dl.-my-3.divide-y.divide-gray-100.text-sm
     ...
     [:div.grid.grid-cols-1.gap-1.p-3.even:bg-gray-50.sm:grid-cols-3.sm:gap-4
      [:dt.font-medium.text-gray-900 "Password"]
      [:dd.text-gray-700.sm:col-span-2 password]]
     [:div.grid.grid-cols-1.gap-1.p-3.even:bg-gray-50.sm:grid-cols-3.sm:gap-4
